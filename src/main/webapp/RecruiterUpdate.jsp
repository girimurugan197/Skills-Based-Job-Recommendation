...
<body style="background-color:grey">
	...
	<div>
		...
		<div class="container">
			<form action="RecruiterUpdateServlet" method="post" >
				<br>
				...
				<div>
					<div>
						...
						<label>LastName:</label> <input class="input" type="text"
							name="LastName" value = "${LastName}" max="20" required><br><br>
					</div>
					<div>
						<label>Email:</label> 
						...
						<label>Mobile No:</label> <input class="input" type="tel"
							name="numericField"  value = "${Mobile}" maxlength="10" pattern="[0-9]{10}" title="Please include only numbers in this field" required><br><br>
					</div>
					<div>
						<label>Company/Organization:</label> <input class="input" type="text"
							name="Company"  value="${Company}" required>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label>Recruiter Id:</label> <input type="text id="RecruiterId" name="RecruiterId" value="${RecruiterId}" placeholder="Enter your id">
					...
					<div>
						<label>Location:</label> <input class="input" type="text"
							name="Location" placeholder="Location" value = "${Location}" required>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
